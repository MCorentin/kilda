...
genome_fasta  = params.kmer_DB.genome_fasta ? Channel.fromPath(params.kmer_DB.genome_fasta) : ""
genome_fai    = params.kmer_DB.genome_fai   ? Channel.fromPath(params.kmer_DB.genome_fai)   : ""
kiv2_bed      = params.kmer_DB.kiv2_bed     ? Channel.fromPath(params.kmer_DB.kiv2_bed)     : ""
norm_bed      = params.kmer_DB.norm_bed     ? Channel.fromPath(params.kmer_DB.norm_bed)     : ""

// Initialising count options:
rsids         = params.rsids_list           ? Channel.fromPath(params.rsids_list)           : ""
samplesheet   = params.count.samplesheet    ? Channel.fromPath(params.count.samplesheet)    : ""
kiv2_kmers    = params.count.kiv2_kmers     ? Channel.fromPath(params.count.kiv2_kmers)     : ""
norm_kmers    = params.count.norm_kmers     ? Channel.fromPath(params.count.norm_kmers)     : ""

kilda         = params.tools.kilda          ? Channel.fromPath(params.tools.kilda)          : ""
...
workflow kiv2_counts {
    ...
    kilda(kiv2_kmers, norm_kmers, kilda, counts_list_ch)
}
...
workflow {
    ...
    if(params.count.count_kiv2) {
        ...
        if(kilda == "")          error("ERROR: The path to kilda.py must be provided (see tools.kilda)")
